...
INSERT INTO SPEAKER(id, name, email, bio, picture_url, twitter_id, created_at, updated_at) values (
   1,
   'Guillaume Bort',
...
INSERT INTO PROPOSAL(title, content, type, is_approved, keywords, speaker_id, created_at, updated_at) values (
